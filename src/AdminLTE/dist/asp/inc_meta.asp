...
<!-- Brand Icon -->
<link href="<%= SITE_ROOT %>dist/fonts/crudestyles.css" rel="stylesheet" />

<!-- jQuery 3 -->
<script src="<%= SITE_ROOT %>bower_components/jquery/dist/jquery.min.js"></script>
...
<script src="<%= SITE_ROOT %>plugins/datatables/dataTables.bootstrap4.min.js"></script>
